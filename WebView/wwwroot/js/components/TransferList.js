...
class TransferList extends Component {
    ...
    static getDerivedStateFromProps(props, state) {
        ...
        if (props.listData !== state.listData) {
            newState.listData = props.listData
        }
        if (props.updateMutableRow !== state.updateMutableRow) {
            newState.updateMutableRow = props.updateMutableRow
        }

        if (newState.listData || newState.updateMutableRow) {
            return newState;
        }
        return null;
    }
